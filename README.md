...
My original code was written is Node.js, but thanks to GPT, I got a Python version in 5 seconds. :-) 
...
You need either `Node.js` (https://nodejs.org/en) or Python 3.  I wrote the Node.js script, and I refer to this script below. I tested `generate-letter.py` generated by GPT-4. It seems fine. 
